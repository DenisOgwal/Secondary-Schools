    ...
    public partial class frmFeePaymentRecord1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FDCourse)[Class],RTRIM(FDBranch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine]  from FeePayment where DateOfPayment between @date1 and @date2 and FDCourse= '" + Course.Text + "'and FDBranch='" + Branch.Text + "' order by ID Desc", con);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand(" select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FDCourse)[CLas],RTRIM(FDBranch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment where DateOfPayment between @date1 and @date2 order by ID DESC ", con);
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeesBalance.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FDCourse)[Class],RTRIM(FDBranch)[Section],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(DueFees)[Due Fees],RTRIM(TotalDue)[Total School Fees Due] from FeesBalance where TotalDue > 0 order by ID DESC ", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeePayment.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FDCourse)[Class],RTRIM(FDBranch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment where DateOfPayment between @date1 and @date2 and Fine > 0 order by ID Desc ", con);
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeePayment.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FDCourse)[Class],RTRIM(FDBranch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Last Installment],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees] from FeePayment where FeePayment.Semester='" + terms.Text + "' and FeePayment.FDCourse='" + classes.Text + "' and FeePayment.Year='" + years.Text + "' and DueFees > 0 order by ID Desc ", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "FeePayment");
            ...
            try
            {
                ...
                switch (dataGridView2.Columns[e.ColumnIndex].Index)
                {
                    case 2:
                        ...
                        frm.studentno.Text = dr.Cells[2].Value.ToString();
                        frm.studentname.Text = dr.Cells[3].Value.ToString();
                        frm.studentyear.Text = dr.Cells[1].Value.ToString();
                        frm.studentclass.Text = dr.Cells[4].Value.ToString();
                        frm.studentterm.Text = dr.Cells[7].Value.ToString();
                        frm.ShowDialog();
                        break;
                }
            }
        ...
        private void ScholarNo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name],RTRIM(FeePayment.FDCourse)[CLass],RTRIM(FDBranch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment where FeePayment.ScholarNo= '" + ScholarNo.Text + "' order by ID Desc ", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "FeePayment");
