    ...
    public partial class frmStudentRecord : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(Student.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name], RTRIM(Admission_No)[Admission No.], RTRIM(DateOfAdmission)[Date Of Admission], RTRIM(Enrollment_no)[Enrollment No.], RTRIM(Fathers_Name)[Father's Name],RTRIM(Mother_name)[Mother's Name], RTRIM(Gender)[Gender], RTRIM(DOB)[DOB],RTRIM(Category)[Category],RTRIM(Religion)[Religion],RTRIM(Student.session)[Year], RTRIM(Address)[Address], RTRIM(Contact_No)[Contact No.], RTRIM(Email)[Email], RTRIM(Student.Course)[Class], RTRIM(Student.Branch)[Level],RTRIM(Semester)[Term],RTRIM(Section)[Stream], RTRIM(Submitted_Documents)[Documents Submitted], RTRIM(Nationality)[Nationality], RTRIM(High_School_name)[P.7 School], RTRIM(HS_Year_of_passing)[Year Of Passing], RTRIM(HS_Percentage)[Percentage], RTRIM(HS_Board)[Board], RTRIM(Higher_secondary_Name)[O'Level], RTRIM(H_year_of_passing)[O'level Year Of Passing], RTRIM(H_percentage)[O'Level Percentage], RTRIM(H_board)[Board]  from student,Batch where  Student.Course= '" + cmbCourse.Text + "'and Student.branch='" + cmbBranch.Text + "'and Student.Session='" + cmbSession.Text + "' and Semester= '" + cmbSemester.Text + "' and Section= '" + cmbSection.Text + "' order by student_name", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(Student.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name], RTRIM(Admission_No)[Admission No.], RTRIM(DateOfAdmission)[Date Of Admission], RTRIM(Enrollment_no)[Enrollment No.], RTRIM(Fathers_Name)[Father's Name],RTRIM(Mother_name)[Mother's Name], RTRIM(Gender)[Gender], RTRIM(DOB)[DOB],RTRIM(Category)[Category],RTRIM(Religion)[Religion],RTRIM(Student.session)[Year], RTRIM(Address)[Address], RTRIM(Contact_No)[Contact No.], RTRIM(Email)[Email], RTRIM(Student.Course)[CLass], RTRIM(Student.Branch)[Level],RTRIM(Semester)[Term],RTRIM(Section)[Stream], RTRIM(Submitted_Documents)[Documents Submitted], RTRIM(Nationality)[Nationality], RTRIM(High_School_name)[P.7 School], RTRIM(HS_Year_of_passing)[Year Of Passing], RTRIM(HS_Percentage)[Percentage], RTRIM(HS_Board)[Board], RTRIM(Higher_secondary_Name)[O'level Secondary], RTRIM(H_year_of_passing)[O'level Year Of Passing], RTRIM(H_percentage)[ Percentage], RTRIM(H_board)[Board]  from student,Batch where Student.Course=batch.Course and DateOfAdmission between @date1 and @date2", con);
        ...
        private void StudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand(" select RTrim(Student.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name], RTRIM(Admission_No)[Admission No.], RTRIM(DateOfAdmission)[Date Of Admission], RTRIM(Enrollment_no)[Enrollment No.], RTRIM(Fathers_Name)[Father's Name],RTRIM(Mother_name)[Mother's Name], RTRIM(Gender)[Gender], RTRIM(DOB)[DOB],RTRIM(Category)[Category],RTRIM(Religion)[Religion],RTRIM(Student.session)[Year], RTRIM(Address)[Address], RTRIM(Contact_No)[Contact No.], RTRIM(Email)[Email], RTRIM(Student.Course)[Class], RTRIM(Student.Branch)[Level],RTRIM(Semester)[Term],RTRIM(Section)[Stream], RTRIM(Submitted_Documents)[Documents Submitted], RTRIM(Nationality)[Nationality], RTRIM(High_School_name)[P.7 School], RTRIM(HS_Year_of_passing)[Year Of Passing], RTRIM(HS_Percentage)[Percentage], RTRIM(HS_Board)[Board], RTRIM(Higher_secondary_Name)[O'Level Secondary], RTRIM(H_year_of_passing)[O'level Year Of Passing], RTRIM(H_percentage)[Percentage], RTRIM(H_board)[Board]  from student,Batch where Student.Course=batch.Course and Student_Name= '" + StudentName.Text + "'", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Student");
                myDA.Fill(myDataSet, "Batch");
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand(" select RTrim(Student.ScholarNo)[LIN], RTRIM(Student_Name)[Student Name], RTRIM(Admission_No)[Admission No.], RTRIM(DateOfAdmission)[Date Of Admission], RTRIM(Enrollment_no)[Enrollment No.], RTRIM(Fathers_Name)[Father's Name],RTRIM(Mother_name)[Mother's Name], RTRIM(Gender)[Gender], RTRIM(DOB)[DOB],RTRIM(Category)[Category],RTRIM(Religion)[Religion],RTRIM(Student.session)[Year], RTRIM(Address)[Address], RTRIM(Contact_No)[Contact No.], RTRIM(Email)[Email], RTRIM(Student.Course)[Class], RTRIM(Student.Branch)[Level],RTRIM(Semester)[Term],RTRIM(Section)[Stream], RTRIM(Submitted_Documents)[Documents Submitted], RTRIM(Nationality)[Nationality], RTRIM(High_School_name)[ Primary School], RTRIM(HS_Year_of_passing)[Year Of Passing], RTRIM(HS_Percentage)[Percentage], RTRIM(HS_Board)[Board], RTRIM(Higher_secondary_Name)[O'Level], RTRIM(H_year_of_passing)[ Year Of Passing], RTRIM(H_percentage)[Percentage], RTRIM(H_board)[Board]  from student,Batch where Student.Course=batch.Course and Student_Name like '" + txtStudent.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Student");
                myDA.Fill(myDataSet, "Batch");
