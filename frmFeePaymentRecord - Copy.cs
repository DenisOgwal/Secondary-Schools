    ...
    public partial class frmFeePaymentRecord : Form
    {
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(FeePayment.FDCourse)[CLass],RTRIM(Student.Branch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment,Student where Student.ScholarNo=FeePayment.ScholarNo and Student.Session=FeePayment.Year and Student.Course=FeePayment.FDCourse and FeePayment.ScholarNo= '" + ScholarNo.Text + "' order by DateOfPayment ", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[Class],RTRIM(Student.Branch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine]  from FeePayment,Student where Student.ScholarNo=Feepayment.scholarNo and Student.Session=FeePayment.Year and Student.Course=FeePayment.FDCourse and DateOfPayment between @date1 and @date2 and Student.Course= '" + Course.Text + "'and Student.branch='" + Branch.Text + "' order by DateOfPayment", con);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand(" select RTrim(FeePaymentID)[Fee Payment ID],RTrim(Year)[Year],RTrim(FeePayment.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[CLas],RTRIM(Student.Branch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment,Student where Student.ScholarNo=FeePayment.ScholarNo and Student.Session=FeePayment.Year and Student.Course=FeePayment.FDCourse and DateOfPayment between @date1 and @date2 order by DateOfPayment ", con);
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeesBalance.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[Class],RTRIM(Student.Branch)[Section],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(DueFees)[Due Fees],RTRIM(TotalDue)[Total School Fees Due] from FeesBalance,Student where Student.ScholarNo=FeesBalance.ScholarNo and TotalDue > 0 order by DateOfPayment ", con);
                ...
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "FeesBalance");
                myDA.Fill(myDataSet, "Student");
                dataGridView4.DataSource = myDataSet.Tables["Student"].DefaultView;
                dataGridView4.DataSource = myDataSet.Tables["FeesBalance"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeePayment.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[Class],RTRIM(Student.Branch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine] from FeePayment,Student where Student.ScholarNo=FeePayment.ScholarNo  and Student.Session=FeePayment.Year and Student.Course=FeePayment.FDCourse and DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment ", con);
                        ...
                        foreach (DataGridViewRow row in dataGridView4.Rows)
                        {
                            ...
                            if (!row.IsNewRow)
                            {
                                if ((row.Cells[1].Value) != null)
                                {
                                    ...
                                    messages = row.Cells[2].Value + " has a Due to us balance of " + row.Cells[12].Value + " on his fees payment for " + row.Cells[6].Value + " Term and your reminded to bring it.";
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeePayment.ScholarNo)[Student No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[Class],RTRIM(Student.Branch)[Section],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Term],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Last Installment],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees] from FeePayment,Student where Student.ScholarNo=FeePayment.ScholarNo and Student.Session=FeePayment.Year and Student.Course=FeePayment.FDCourse and FeePayment.Semester='"+terms.Text+"' and FeePayment.FDCourse='"+classes.Text+"' and FeePayment.Year='"+years.Text+"' and DueFees > 0 order by DateOfPayment ", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Student");
                myDA.Fill(myDataSet, "FeePayment");
                dataGridView6.DataSource = myDataSet.Tables["Student"].DefaultView;
                dataGridView6.DataSource = myDataSet.Tables["FeePayment"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
