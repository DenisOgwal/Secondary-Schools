    ...
    public partial class frmPurchasesReport : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cms_purchases myDS = new cms_purchases();
                //The DataSet you created.
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from Purchases where purchasedate between @date1 and @date2 order by purchasedate";
                MyCommand.Parameters.Add("@date1", SqlDbType.DateTime, 30, "purchasedate").Value = PaymentDateFrom.Value.Date;
                MyCommand.Parameters.Add("@date2", SqlDbType.DateTime, 30, "purchasedate").Value = PaymentDateTo.Value.Date;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from Purchases where purchasedate between @date1 and @date2 and product= '" + Course.Text + "' order by purchasedate";
                MyCommand.Parameters.Add("@date1", SqlDbType.DateTime, 30, "purchasedate").Value = Date_from.Value.Date;
                MyCommand.Parameters.Add("@date2", SqlDbType.DateTime, 30, "purchasedate").Value = Date_to.Value.Date;
                MyCommand.CommandType = CommandType.Text;
                myDA.SelectCommand = MyCommand;
                myDA.Fill(myDS, "Purchases");
                rpt.SetDataSource(myDS);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Cursor = Cursors.WaitCursor;
                timer1.Enabled = true;
                rptpurchaseById rpt = new rptpurchaseById();
                //The report you created.
                SqlConnection myConnection = default(SqlConnection);
                SqlCommand MyCommand = new SqlCommand();
                SqlDataAdapter myDA = new SqlDataAdapter();
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from Purchases where purchaseid= '" + ScholarNo.Text + "'order by purchasedate";
                MyCommand.CommandType = CommandType.Text;
                myDA.SelectCommand = MyCommand;
                myDA.Fill(myDS, "Purchases");
                rpt.SetDataSource(myDS);
