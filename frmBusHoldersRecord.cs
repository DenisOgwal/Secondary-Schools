    ...
    public partial class frmBusHoldersRecord : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and StartingDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by StartingDate", con);
