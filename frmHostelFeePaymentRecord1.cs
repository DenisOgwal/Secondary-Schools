    ...
    public partial class frmHostelFeePaymentRecord1 : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(HostelFeePayment.ScholarNo)[LIN],RTRIM(HostelFeePayment.Student_name)[Student Name],RTRIM(HostelFeePayment.Class)[Class],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Year],(HostelFeePayMent.Term)[Term] from HostelFeePayment INNER JOIN (SELECT ScholarNo,Class,Year,Term, Max(ID) as ID from HostelFeePayment group by ScholarNo,Class,Year,Term) AS b ON HostelFeePayment.ScholarNo=b.ScholarNo and HostelFeePayment.Class=b.Class and HostelFeePayment.Year=b.Year and HostelFeePayment.Term=b.Term and HostelFeePayment.ID=b.ID and DateOfPayment between @date1 and @date2 and DueFees > 0", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Year],(HostelFeePayMent.Term)[Term] from HostelFeePayment where DateOfPayment between @date1 and @date2 and Class= '" + Course.Text + "' order by DateOfPayment", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Year],(HostelFeePayMent.Term)[Term] from HostelFeePayment where DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment", con);
