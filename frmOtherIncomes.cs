...
{
    public partial class frmOtherIncomes : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into OtherIncomes(TransactionType,Date,Amount,Description,Term,Year,Reason) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7)";
        ...
        private void delete_records()
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete from OthertIncomes where TransactionID=@DELETE1;";
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update OtherIncomes set TransactionType=@d1,Date=@d2,Amount=@d3,Description=@d4,Term=@d5,Year=@d6 where TransactionType=@d1  and Date=@d2 and Year=@d6 and Term=@d5";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 10, "TransactionType"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 30, "Date"));
        ...
        {
            this.Hide();
            frmOtherIncomeRecord frm = new frmOtherIncomeRecord();
