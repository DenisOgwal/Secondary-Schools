...
{
    public partial class frmDrawingsRecord :Form
    {
        ...
        {
            dynamic SelectQry = "SELECT RTRIM(DrawingsID)[Drawings ID],RTRIM(DateRegistered)[Withdraw Date],RTRIM(Price)[Ammount],RTRIM(Description)[Description],RTRIM(Term)[Term],RTRIM(Year)[Year] FROM Drawings order by ID DESC ";
