...
{
    public partial class FrmSickStudentDischarge : Form
    {
        ...
        public FrmSickStudentDischarge()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {   
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update SickBayAdmissions set DischargeNotes=@d8,Discharged=@d9,DischargeDate=@d10 where ScholarNo=@d1 and Year=@d5 and Class=@d6 and Term=@d7";
                ...
                cmd.Parameters.Add(new SqlParameter("@d8", System.Data.SqlDbType.NChar, 500, "DischargeNotes"));
                cmd.Parameters.Add(new SqlParameter("@d9", System.Data.SqlDbType.NChar, 10, "Discharged"));
                cmd.Parameters.Add(new SqlParameter("@d10", System.Data.SqlDbType.NChar, 20, "DischargeDate"));
                ...
                cmd.Parameters["@d9"].Value = "Yes";
                cmd.Parameters["@d10"].Value = dtpJoiningDate.Text;
                cmd.ExecuteNonQuery();
                con.Close();            
        ...
        {
            this.Hide();
            FrmSickStudentDischargeRecord frm = new FrmSickStudentDischargeRecord();
