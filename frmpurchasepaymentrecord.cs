...
{
    public partial class frmpurchasepaymentrecord : Form
    {
        ...
        public frmpurchasepaymentrecord()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                myDA.Fill(myDataSet, "PurchasePayment");
                dataGridView1.DataSource = myDataSet.Tables["PurchasePayment"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
