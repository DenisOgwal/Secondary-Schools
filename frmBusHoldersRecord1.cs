    ...
    public partial class frmBusHoldersRecord1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and StartingDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by StartingDate", con);
        ...
        private void AutocompleteStudentname()
        {
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(Student_name) FROM BusHolders", CN);
                ds = new DataSet("ds");
                adp.Fill(ds);
                dtable = ds.Tables[0];
        ...
        private void cmbStudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and BusHolders.Student_name = '" + cmbStudentName.Text + "' order by BusHolders.Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void txtStudentName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and BusHolders.Student_name like '" + txtStudentName.Text + "%' order by BusHolders.Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void txtSourceLocation_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and SourceLocation like '" + txtSourceLocation.Text + "%' order by BusHolders.Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void cmbSourceLocation_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and SourceLocation = '" + cmbSourceLocation.Text + "' order by BusHolders.Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void ScholarNo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[LIN],RTRIM(BusHolders.Student_name)[Student Name],RTRIM(Course)[Class],RTRIM(Branch)[Level],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Year],RTRIM(BusHolders.Term)[Term]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and Student.ScholarNo = '" + ScholarNo.Text + "' order by BusHolders.Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
