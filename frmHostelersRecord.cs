    ...
    public partial class frmHostelersRecord : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where JoiningDate between @date1 and @date2 and Class= '" + Course.Text + "' order by JoiningDate", con);
        ...
        private void AutocompleteStudentname()
        {
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(Student_name) FROM Hostelers ", CN);
                ds = new DataSet("ds");
                adp.Fill(ds);
                dtable = ds.Tables[0];
        ...
        private void cmbStudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where Student_name = '" + cmbStudentName.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
        ...
        private void txtStudentName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where Student_name like '" + txtStudentName.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                dataGridView3.DataSource = myDataSet.Tables["Hostelers"].DefaultView;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year] ,RTRIM(Hostelers.Term)[Term]from Hostelers where JoiningDate between @date1 and @date2 order by JoiningDate", con);
        ...
        private void cmbHostelName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where HostelName = '" + cmbHostelName.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
        ...
        private void txtHostelName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where HostelName like '" + txtHostelName.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                dataGridView5.DataSource = myDataSet.Tables["Hostelers"].DefaultView;
        ...
        private void ScholarNo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarNo)[LIN],RTRIM(Student_name)[Student Name],RTRIM(Class)[Class],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Bed No.],RTRIM(Year)[Year],RTRIM(Hostelers.Term)[Term] from Hostelers where ScholarNo = '" + ScholarNo.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
