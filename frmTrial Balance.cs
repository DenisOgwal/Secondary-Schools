    ...
    //
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                timer1.Enabled = true;
                rptTrialBalance rpt = new rptTrialBalance(); //The report you created.
                SqlConnection myConnection = default(SqlConnection);
                SqlCommand MyCommand = new SqlCommand();
                SqlDataAdapter myDA = new SqlDataAdapter();
                cms_purchases myDS = new cms_purchases(); //The DataSet you created.
                frmFinancialSummaryReport1 frm = new frmFinancialSummaryReport1();
                ...
                rpt.SetParameterValue("busfeespayment", buspaidsummary.Text);
                rpt.SetParameterValue("bushirepayment", bushirepaidsummary.Text);
                rpt.SetParameterValue("feespayment", label34.Text);
                rpt.SetParameterValue("otherincomes", incomespaid.Text);
                rpt.SetParameterValue("accruedincomes", label32.Text);
                rpt.SetParameterValue("expenses",totalexpenses.Text);
                rpt.SetParameterValue("accruedexpenses", expensesdue);
                rpt.SetParameterValue("staffpayment", salarypaidsummary.Text);
                rpt.SetParameterValue("accruedsalary", salarypaymentdue);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = Cursors.WaitCursor;
                timer1.Enabled = true;
                rptTrialBalanceYear rpt = new rptTrialBalanceYear(); //The report you created.
                SqlConnection myConnection = default(SqlConnection);
                SqlCommand MyCommand = new SqlCommand();
                SqlDataAdapter myDA = new SqlDataAdapter();
                cms_purchases myDS = new cms_purchases(); //The DataSet you created.
                ...
                rpt.SetParameterValue("broughtforward", label30.Text);
                rpt.SetParameterValue("cashathand", label31.Text);
                rpt.SetParameterValue("busfeespayment", buspaidsummary1.Text);
                rpt.SetParameterValue("bushirepayment", bushirepaidsummary1.Text);
                rpt.SetParameterValue("feespayment", label34.Text);
                rpt.SetParameterValue("otherincomes", incomespaid1.Text);
                rpt.SetParameterValue("accruedincomes", label32.Text);
                rpt.SetParameterValue("expenses", totalexpenses1.Text);
                rpt.SetParameterValue("accruedexpenses", expensesdue1);
                rpt.SetParameterValue("staffpayment", salarypaidsummary1.Text);
                rpt.SetParameterValue("accruedsalary", salarypaymentdue1);
                rpt.SetParameterValue("equipment", label39.Text);
                rpt.SetParameterValue("purchasespayment", label41.Text);
                rpt.SetParameterValue("duepayments", label32.Text);
                rpt.SetParameterValue("duepaymentsliability", label33.Text);
        ...
        private void groupBox37_Enter(object sender, EventArgs e)
        {

        }

        private void salarypaidsummary1_TextChanged(object sender, EventArgs e)
        {
