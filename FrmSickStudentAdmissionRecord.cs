...
{
    public partial class FrmSickStudentAdmissionRecord : Form
    {
        ConnectionString cs = new ConnectionString();

        public FrmSickStudentAdmissionRecord()
        {
            InitializeComponent();
        }
        ...
        {
            dynamic SelectQry = "SELECT RTRIM(ID)[ID],RTRIM(ScholarNo)[Student No.],RTRIM(Year)[Year],RTRIM(Class)[Class],RTRIM(Term)[Term],RTRIM(BedNo)[Bed Name],RTRIM(JoiningDate)[Admission Date] FROM SickBayAdmissions order by ID Desc";
