    ...
    public partial class frmSubjectInfo : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into subjectinfo(subjectcode,subjectname,coursename,branch,semester,Paper) VALUES (@d1,@d2,@d4,@d5,@d6,@d7)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 10, "Paper"));
                ...
                cmd.Parameters["@d7"].Value = paper.Text.Trim();
                cmd.ExecuteNonQuery();
            ...
            if (cmbBranch.Text == "A Level")
            {
                try
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string cb = "insert into SubjectInfoA(subjectCodeA,subjectNameA,Class,Level,Term,Paper) VALUES (@d1,@d2,@d4,@d5,@d6,@d7)";
                    cmd = new SqlCommand(cb);
                    cmd.Connection = con;
                    cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 20, "SubjectCodeA"));
                    cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.VarChar, 250, "subjectNameA"));
                    cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.NChar, 20, "Class"));
                    cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 20, "Paper"));
                    cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.NChar, 50, "Level"));
             ...
             private void delete_records()
        {
            ...
            try
            {
                ...
                con.Open();
                string ct1 = "select SubjectCode from Results where SubjectCode=@find";
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq1 = "delete from subjectinfoA where subjectcodeA=@DELETE1;";
                cmd = new SqlCommand(cq1);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@DELETE1", System.Data.SqlDbType.NChar, 20, "subjectcodeA"));
                cmd.Parameters["@DELETE1"].Value = SubjectCode.Text;
                RowsAffected = cmd.ExecuteNonQuery();
                if (RowsAffected > 0)
                {
