    ...
    //
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Registration Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Registration Fee'", con);
                    registrationfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Development Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Development Fee'", con);
                    developmentfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='UNSA Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='UNSA Fee'", con);
                    unsafee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Sesemat Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Sesemat Fee'", con);
                    sesematfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='UNEB Reg Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='UNEB Reg Fee'", con);
                    unebregistrationfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Ream' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Ream'", con);
                    reamsummary.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Sports Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Sports Fee'", con);
                    sportsfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Uniform' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Uniform'", con);
                    uniformfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Identity Card & Photos' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Identity Card & Photos'", con);
                    identitycardfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Tools' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Tools'", con);
                    toolsfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Hostel' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Hostel'", con);
                    hostelfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Others' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year.Text + "' and Semester='" + term.Text + "' and FeeName='Others'", con);
                    othersfee.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                ...
                totalincomespayable.Text = (Convert.ToInt32(shoolfeestotalpaidsummary.Text) + Convert.ToInt32(buspaidsummary.Text) + Convert.ToInt32(bushirepaidsummary.Text) + Convert.ToInt32(scholarshippaidsummary.Text) + Convert.ToInt32(incomespaid.Text) + Convert.ToInt32(label59.Text)).ToString();
                ...
                label31.Text = ((Convert.ToInt32(totalincomespayable.Text) + Convert.ToInt32(label59.Text) + Convert.ToInt32(label30.Text) + balanceforward) - (drawings + Convert.ToInt32(costofservice.Text))).ToString();
        ...
        private void Reset()
        {
            ...
            unsafee.Text = "";
            sesematfee.Text = "";
            unebregistrationfee.Text = "";
            sportsfee.Text = "";
            reamsummary.Text = "";
            uniformfee.Text = "";
            identitycardfee.Text = "";
            toolsfee.Text = "";
            hostelfee.Text = "";
            othersfee.Text = "";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Registration Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Registration Fee'", con);
                    registrationfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Development Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Development Fee'", con);
                    developmentfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='UNSA Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='UNSA Fee'", con);
                    unsafee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Sesemat Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Sesemat Fee'", con);
                    sesematfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='UNEB Reg Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='UNEB Reg Fee'", con);
                    unebfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Ream' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Ream'", con);
                    reamsummary1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Sports Fee' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Sports Fee'", con);
                    sportsfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "' and FeeName='Uniform' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Uniform'", con);
                    uniformfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Identity Card & Photos' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Identity Card & Photos'", con);
                    identitycardfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Tools' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Tools'", con);
                    toolsfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Hostel' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Hostel'", con);
                    hostelfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select TotalPaid from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Others' ", con);
                rdr = cmd.ExecuteReader();
                if (rdr.Read())
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    cmd = new SqlCommand("select SUM(TotalPaid) from OtherFeePayment where Year='" + year2.Text + "'  and FeeName='Others'", con);
                    othersfee1.Text = cmd.ExecuteScalar().ToString();
                    con.Close();
                    if ((rdr != null))
                    {
                        rdr.Close();
            ...
            try
            {
                ...
                totalincomespayable1.Text = (Convert.ToInt32(shoolfeestotalpaidsummary1.Text) + Convert.ToInt32(buspaidsummary1.Text) + Convert.ToInt32(bushirepaidsummary1.Text) + Convert.ToInt32(scholarshippaidsummary1.Text) + Convert.ToInt32(incomespaid1.Text) + Convert.ToInt32(label59.Text)).ToString();
        ...
        private void Reset2()
        {
            ...
            registrationfee1.Text = "";
            developmentfee1.Text = "";
            unsafee1.Text = "";
            sesematfee1.Text = "";
            unebfee1.Text = "";
            sportsfee1.Text = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rpt.SetParameterValue("feespaid", label34.Text);
                rpt.SetParameterValue("hirepaid", bushirepaidsummary.Text);
                rpt.SetParameterValue("buspaid", buspaidsummary.Text);
                rpt.SetParameterValue("accruedincomes", label32.Text);
                rpt.SetParameterValue("salarypaid", salarypaidsummary.Text);
                rpt.SetParameterValue("purchasesammount",purchasespaidsummary.Text);
                rpt.SetParameterValue("accruedsalary", salarypaymentdue.ToString());
                rpt.SetParameterValue("expensesammount",totalexpenses.Text);
                rpt.SetParameterValue("accruedexpenses", expensesdue.ToString());
                rpt.SetParameterValue("accruedpurchases", purchaseduepayment.ToString());
                rpt.SetParameterValue("othersincome", incomespaid.Text);

                rpt.SetParameterValue("registration", registrationfee.Text);
                rpt.SetParameterValue("development", developmentfee.Text);
                rpt.SetParameterValue("unsa", unsafee.Text);
                rpt.SetParameterValue("uneb", unebregistrationfee.Text);
                rpt.SetParameterValue("sesemat", sesematfee.Text);
                rpt.SetParameterValue("sports", sportsfee.Text);
                rpt.SetParameterValue("ream", reamsummary.Text);
                rpt.SetParameterValue("hostel", hostelfee.Text);
                rpt.SetParameterValue("tools", toolsfee.Text);
                rpt.SetParameterValue("others", othersfee.Text);
                rpt.SetParameterValue("uniform", uniformfee.Text);
                rpt.SetParameterValue("identitycard", identitycardfee.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = Cursors.WaitCursor;
                timer1.Enabled = true;
                rptschoolincomestatementYear rpt = new rptschoolincomestatementYear(); //The report you created.
                SqlConnection myConnection = default(SqlConnection);
                SqlCommand MyCommand = new SqlCommand();
                SqlDataAdapter myDA = new SqlDataAdapter();
                cms_purchases myDS = new cms_purchases(); //The DataSet you created.
                ...
                rpt.SetParameterValue("feespaid", label34.Text);
                rpt.SetParameterValue("hirepaid", bushirepaidsummary1.Text);
                rpt.SetParameterValue("buspaid", buspaidsummary1.Text);
                rpt.SetParameterValue("accruedincomes", label32.Text);
                rpt.SetParameterValue("salarypaid", salarypaidsummary1.Text);
                rpt.SetParameterValue("purchasesammount", purchasespaidsummary1.Text);
                rpt.SetParameterValue("accruedsalary", salarypaymentdue1.ToString());
                rpt.SetParameterValue("expensesammount", totalexpenses1.Text);
                rpt.SetParameterValue("accruedexpenses", expensesdue1.ToString());
                rpt.SetParameterValue("accruedpurchases", purchaseduepayment1.ToString());
                rpt.SetParameterValue("othersincome", incomespaid1.Text);

                rpt.SetParameterValue("registration", registrationfee1.Text);
                rpt.SetParameterValue("development", developmentfee1.Text);
                rpt.SetParameterValue("unsa", unsafee1.Text);
                rpt.SetParameterValue("uneb", unebfee1.Text);
                rpt.SetParameterValue("sesemat", sesematfee1.Text);
                rpt.SetParameterValue("sports", sportsfee1.Text);
                rpt.SetParameterValue("ream", reamsummary1.Text);
                rpt.SetParameterValue("hostel", hostelfee1.Text);
                rpt.SetParameterValue("tools", toolsfee1.Text);
                rpt.SetParameterValue("others", othersfee1.Text);
                rpt.SetParameterValue("uniform", uniformfee1.Text);
                rpt.SetParameterValue("identitycard", identitycardfee1.Text);
                rpt.SetParameterValue("companyname", companyname);
                //rpt.SetParameterValue("companyemail", companyemail);
                rpt.SetParameterValue("companycontact", companycontact);
                rpt.SetParameterValue("companyslogan", companyslogan);
