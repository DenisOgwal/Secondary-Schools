    ...
    public partial class frmHostelersReport : Form
    {
        ...
        private void AutocompleteStudentname()
        {
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(Hostelers.Student_name) FROM Student,Hostelers where Student.ScholarNo=Hostelers.ScholarNo", CN);
                ds = new DataSet("ds");
                adp.Fill(ds);
                dtable = ds.Tables[0];
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {        
                ...
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and JoiningDate between @date1 and @date2 order by Hostelers.Student_name ";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and JoiningDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by Student.Student_name ";
        ...
        private void cmbStudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Student_name= '" + cmbStudentName.Text + "' order by Student.Student_name ";
        ...
        private void txtStudentName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Student_name like '" + txtStudentName.Text + "%' order by Student.Student_name ";
        ...
        private void cmbHostelName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and hostelname= '" + cmbHostelName.Text + "' order by Student.Student_name ";
        ...
        private void txtHostelName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Hostelname like '" + txtHostelName.Text + "%' order by Student.Student_name ";
        ...
        private void ScholarNo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.ScholarNo= '" + ScholarNo.Text + "' order by Student.Student_name ";
                MyCommand.CommandType = CommandType.Text;
                myDA.SelectCommand = MyCommand;
                myDA.Fill(myDS, "Hostelers");
                myDA.Fill(myDS, "Student");
